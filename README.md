...
> Projeto privado em desenvolvimento e uso interno.
...
Ferramenta em Python para transcrição de áudio utilizando Whisper.

**Tecnologias:** `Python` `Whisper` `Automação`

🔗 [Ver repositório](https://github.com/Kayky-Ferreira/transcricao-python-whisper)
